...
?>
<nav class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100 px-4 sm:px-6 py-3">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-2">
            <a href="<?= url($user ? ($user['role'] === 'chef' ? '/chef-dashboard' : '/dashboard') : '/') ?>" class="flex items-center gap-2 group">
                <div class="w-9 h-9 sm:w-10 sm:h-10 bg-brand-500 rounded-xl flex items-center justify-center text-white text-lg sm:text-xl shadow-lg shadow-brand-200 transition-transform group-hover:scale-105">
                    🍳
                </div>
